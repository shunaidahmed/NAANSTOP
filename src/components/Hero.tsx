...
const FEATURES_ES = ["A la Parrilla", "Hecho a Pedido", "Cargado de Queso"];
const FEATURES_EN = ["Freshly Grilled", "Made to Order", "Loaded with Cheese"];

const HERO_GALLERY = [
  { src: "https://images.unsplash.com/photo-1552332386-f8dd00dc2f85?auto=format&fit=crop&w=1400&q=85", labelEs: "El favorito de la casa", labelEn: "The house pour", titleEs: "Derretir. Tostar. Repetir.", titleEn: "Melt. Toast. Repeat.", alt: "Fresh tacos ready to serve" },
  { src: "https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?auto=format&fit=crop&w=1400&q=85", labelEs: "Presionado al pedido", labelEn: "Pressed to order", titleEs: "Energía de bocado grande.", titleEn: "Big bite energy.", alt: "Loaded burger with fresh toppings" },
  { src: "https://images.unsplash.com/photo-1585109649139-366815a0d713?auto=format&fit=crop&w=1400&q=85", labelEs: "Lado serio", labelEn: "Side of serious", titleEs: "Las patatas se hacen ruido.", titleEn: "Fries get loud.", alt: "Loaded fries with sauce" },
  { src: "https://images.unsplash.com/photo-1461023058943-07fcbe16d735?auto=format&fit=crop&w=1400&q=85", labelEs: "Derramado frío", labelEn: "Cold pour", titleEs: "Enfríate.", titleEn: "Cool it down.", alt: "Iced coffee on a table" },
  { src: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&w=1400&q=85", labelEs: "Algo dulce", labelEn: "Something sweet", titleEs: "Termina en grande.", titleEn: "End on a high.", alt: "Chocolate shake with cream" },
  { src: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=1400&q=85", labelEs: "Acabado fresco", labelEn: "Fresh finish", titleEs: "Ilumina la mesa.", titleEn: "Brighten the table.", alt: "Fresh lime drink with mint" },
];
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-neutral-900/70 p-3 shadow-[0_35px_100px_rgba(0,0,0,0.45)]">
            <div className="relative aspect-[0.86] overflow-hidden rounded-[1.5rem]">
              ...
              <div className="absolute inset-x-6 bottom-6 flex items-end justify-between gap-4">
                ...
                <span className="font-mono text-xs text-white/55">{String(activeImage + 1).padStart(2, "0")} / {String(HERO_GALLERY.length).padStart(2, "0")}</span>
              </div>
            </div>
          </div>
        </motion.div>
